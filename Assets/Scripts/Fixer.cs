...
{
    [HideInInspector] public Vector3 pos; //Posición que tendrá el fixer en el mundo
    [HideInInspector] public bool hidden; //Variable booleano que marcará si se oculta el fixer (true) o no (false)
    ...
    void Update()
    {
        if (Input.GetKeyUp(KeyCode.S)){ //Al pulsar la tecla S se podrá ocultar o mostrar todos los "fixers"
            hidden = !hidden;
            Hide();
        }
