...
*
* Nombre de la clase: Spring
* Breve descripción: La siguiente clase de C# gestiona todos los cálculos que deben efectuarse en la creación de un muelle (y lo prepara para sus posteriores modificaciones en MassSpring), de este modo, se logra que 
* el animador pueda ver por pantalla una físicas adecuadas.
*****************************************************************************/

public class Spring 
{
    public float k; // Constante de rigidez del muelle (N/m)
